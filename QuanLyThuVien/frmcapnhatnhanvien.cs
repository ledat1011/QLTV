...
namespace QuanLyThuVien
{
    public partial class frmcapnhatnhanvien : Form
    {
        ...
        {
            cls.LoadData2DataGridView(dataGridView1,"select * from tblNhanVien where TAIKHOAN='"+frmMain.TenDN+"'");
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (txtSoDienThoai.Text.Length - 1 <= 0)
                ...
                if (txtSoDienThoai.Text.Length - 1 > 12)
                    ...
                    {
                        string strUpdate = "update tblNhanVien set TENNV='" + txtNHANVIEN.Text + "',DIACHI='" + txtDiaChi.Text + "',DIENTHOAI='" + txtSoDienThoai.Text + "',EMAIL='" + txtEmail.Text + "',ChucVu='" + textBox1.Text + "',Tuoi='" + textBox2.Text + "' where TAIKHOAN='" + frmMain.TenDN + "'";
